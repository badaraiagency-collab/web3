...
export default function MarketingAutomationPage() {
  ...
  const services = [
    {
      ...
      description:
        "Optimized advertising across multiple platforms with AI-driven strategies",
      features: [
    ...
    },
    {
      ...
      description:
        "AI-powered content creation for all channels and formats",
      features: [
        "Blog posts & articles",
    ...
    },
    {
      ...
      description:
        "Automated search engine optimization strategies to boost visibility",
      features: [
        "Keyword research",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-50 via-white to-purple-50">
      ...
      <main>
        {/* Hero Section */}
        <section className="py-20 bg-gradient-to-r from-pink-600 via-rose-500 to-orange-500">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <p className="text-2xl mb-8 opacity-90">
                Ad Campaigns, Content Generation & SEO
              </p>
              <p className="text-xl opacity-80 max-w-3xl mx-auto">
                Scale your marketing efforts with powerful AI-driven automation solutions
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto text-white">
              ...
              <p className="text-xl mb-10 opacity-90">
                Reach more customers with intelligent marketing automation
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  onClick={handleGetStarted}
                  size="lg"
                  className="bg-white text-pink-600 hover:bg-gray-100 px-8 py-6 text-lg font-semibold shadow-lg transition-all"
                >
                  Get Started Now
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="border-2 border-white text-white bg-transparent hover:bg-white hover:text-pink-600 px-8 py-6 text-lg font-semibold transition-all"
                >
                  Schedule Demo
                </Button>
              </div>

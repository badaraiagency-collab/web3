  ...
  const services = [
    {
      ...
      description:
        "Automated ticket routing and priority management for faster resolution",
      features: [
    ...
    },
    {
      ...
      description:
        "Intelligent voice support with natural conversation capabilities",
      features: [
    ...
    },
    {
      ...
      description:
        "Instant answers from your documentation with AI-powered search",
      features: [
        "Intelligent search",
        "Contextual answers",
    ...
    },
    {
      ...
      description:
        "Intelligent chat support with smart escalation to human agents",
      features: [
        "24/7 availability",
        "Smart handoff",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-cyan-50 via-white to-blue-50">
      ...
      <main>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <p className="text-2xl mb-8 opacity-90">
                Helpdesk, Voice Assistants & Live Chat Solutions
              </p>
              <p className="text-xl opacity-80 max-w-3xl mx-auto">
                Enhance customer satisfaction with intelligent support automation
              </p>
            </div>
          </div>
        </section>
        ...
        {/* CTA Section */}
        <section className="py-20 bg-gradient-to-r from-cyan-600 to-indigo-600">
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto text-white">
              ...
              <p className="text-xl mb-10 opacity-90">
                Deliver exceptional support experiences with AI automation
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  onClick={handleGetStarted}
                  size="lg"
                  className="bg-white text-cyan-600 hover:bg-gray-100 px-8 py-6 text-lg font-semibold shadow-lg transition-all"
                >
                  Get Started Now
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="border-2 border-white text-white bg-transparent hover:bg-white hover:text-cyan-600 px-8 py-6 text-lg font-semibold transition-all"
                >
                  Schedule Demo
                </Button>
              </div>
